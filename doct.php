...
<section class="container">
  <h1>
	...
	<span class="title">email address<?php echo $_POST["user_email"]; ?></span>
...
<!--<div style="text-align: center;">
	<h1>Thank you <?php echo $_POST["user_name"]; ?></br> for your interest We will get you back soon via your </br>email address <?php echo $_POST["user_email"]; ?></h1>
...
<?php
    ...
    include_once 'dbcon.php';
			...
			$user_question = mysqli_real_escape_string($connection,$_POST['user_question']);
			$query_date = date('Y-m-d');
				
				echo "<script>console.log( 'Debug Objects: " . $query_date . "' );</script>";
			
			$query = "INSERT INTO `consultant` (`user_id`, `user_name`, `user_email`, `user_question`, `query_date`) VALUES (NULL, '$user_name', '$user_email', '$user_question', '$query_date');";
