...
<table id="customers">
	...
	<tr>
		...
		<td><?php echo '<a href="editprod.php?id='.$row['prod_id'].'"><button  type="submit" ;>edit</button></a>' ?></td>
		<td><?php echo '<a href="deletepost.php?id='.$row['postID'].'"><button  type="submit" ;>delete</button></a>' ?></td>
	</tr>
		<?php } ?>
</table>
